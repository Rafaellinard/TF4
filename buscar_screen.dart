...
class BuscarScreen extends StatefulWidget {
  ...
  const BuscarScreen({super.key, required this.repetidas, required this.faltam, required this.onSolicitar, this.onAvisos});
          ...
          Expanded(child: GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                SizedBox(width: 6),
                Text('Ver Avisos e Pagamento →', style: TextStyle(
